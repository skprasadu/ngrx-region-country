...
import { selectValueCountry, selectValueRegion } from '../ngrx/app.actions';
import { Store } from '@ngrx/store';
import { RequestState } from '../ngrx/app.reducer';

@Component({
  selector: 'app-region-country-component',
  templateUrl: './region-country-component.component.html',
  styleUrls: ['./region-country-component.component.css']
})
export class RegionCountryComponentComponent implements OnInit {
